...
class PGLearner:
    def __init__(self, pa):
        ...
        print('network_output_dim={0}'.format(pa.network_output_dim))
        ...
        print(' params={0} count={1}'.format(params, lasagne.layers.count_params(self.l_out)))
        ...
        print('lr_rate={0}'.format(self.lr_rate))
